...
Then, we propagate the field to a pupil using a Fresnel propagation simulation. At the edge of the pupil, we cut off the field. 
...
With this intensity-only interferogram on the FPA, a Fourier Transform reveals the tilted clones of the aperture field. 
